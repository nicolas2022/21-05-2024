...
class Application(ctk.CTk):
    def __init__(self):
        ...
        self.onglet1ligne2.pack(fill="x", pady=5)
        ...
        self.onglet1ligne3.pack(fill="x", pady=5)
        ...
        self.onglet1ligne4.pack(fill="x", pady=5)
        ...
        self.onglet1ligne4_4 = ctk.CTkEntry(self.onglet1ligne4, width=443, fg_color="#333", text_color="white")
        ...
        self.onglet1ligne5.pack(fill="x", pady=5)
